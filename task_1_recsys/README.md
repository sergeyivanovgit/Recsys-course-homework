...
- Подберите для построенной модели регуляризацию, сделав при этом кросс-валидацию по времени.
- **В работе нельзя использовать SGDlike алгоритмы!**

В качестве метрики считайте log-loss.
